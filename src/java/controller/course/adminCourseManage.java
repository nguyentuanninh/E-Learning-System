 ...
 * @author MSII
 */
@WebServlet(name = "adminCourseManage", urlPatterns = {"/admin-course-manage"})
public class adminCourseManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter(SEARCH) != null && !request.getParameter(SEARCH).equals("")) {
            ...
            allCourse= courseDAO.searchCourse(search);
        } else {
            allCourse = courseDAO.listCourse();
        }
        ...
        request.getRequestDispatcher("adminCourseManage.jsp").forward(request, response);
    }
