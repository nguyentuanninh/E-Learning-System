                        ...
                        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div id="content">
                                ...
                                <%@include file="topBar.jsp" %>
                                        ...
                                        <table class="table bg-white table-bordered">
                                            <div
                                                ...
                                                <div style="display: flex; flex-direction: row; align-items: center;">
                                                    <div class="col-sm-6">
                                                        <a href="add-instructor" class="btn btn-primary"
                                                            style=" white-space: nowrap;"
                                                            title="add instructor"><span>Add Instructor</span></a>
                                                    </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${ol}" var="i">
                                            <tr>
                                                <td>${i.id}</td>
                                                <td>${i.name}</td>
                                                <td><img src="${i.img}" style="height: 40px"></td>
                                                <td>${i.email}</td>
                                                <td>${i.job}</td>
                                                <td>
                                                    <a href="delete-instructor?iid=${i.id}"
                                                        class="btn- btn-danger  btn-sm"> Delete</a>
                                                    <a href="edit-instructor?iid=${i.id}"
                                                ...
                                                <c:forEach begin="1" end="${numberOfPage}" var="i">
                                                    <c:if test="${i== page}">
                                                        <li class="page-item active" aria-current="page">
                                                            <a class="page-link"
                                                                href="instructor-manage?page=${i}">${i}</a>
                                                        </li>
                                                    </c:if>
                                                    <c:if test="${i!= page}">
                                                        <li class="page-item"><a class="page-link"
                                                                href="instructor-manage?page=${i}">${i}</a></li>
                                                    </c:if>
                                                </c:forEach>
                                            </ul>
                                        </nav>
