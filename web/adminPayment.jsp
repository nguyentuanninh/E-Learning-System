                    ...
                    <div class="container-fluid">
                        ...
                        <table class="table bg-white table-bordered">
                            <div
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">List Recharge</h6>
                                <div
                            ...
                            <tbody>
                                <c:forEach items="${listRecharge}" var="c">
                                    <tr style="${c.status== "Error"? "color: red":"color: green"}">
                                        <td>${c.userId== -1?"N/A":userMap.get(c.userId).username}</td>
                                        <td>
                                        ...
                                        <c:if test="${i== page}">
                                            <li class="page-item active" aria-current="page">
                                                <c:if test="${param.search== null}">
                                                    <a class="page-link"
                                                       href="adminPayment?page=${i}">${i}</a>
                                                </c:if>
                                                <c:if test="${param.search!= null}">
                                                    <a class="page-link"
                                                       href="adminPayment?search=${param.search}&page=${i}">${i}</a>
                                                </c:if>
                                            </li>
                                        </c:if>
                                        <c:if test="${i!= page}">
