            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800 pb-4" >Update News</h1>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="Title" name="title"
                                                      ...
                                                      required>${newsup.title}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea class="form-control" id="Description"
                                                      name="description" rows="7" placeholder="News Description"
                                                      required>${newsup.description}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="Content"
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea class="form-control" id="Content"
                                                      ...
                                                      required>${newsup.content}</textarea>
                                        </div>
                                    </div>
                                    <fieldset class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <c:forEach begin="${0}"
                                                           end="${listtypenews.size() - 1}" var="i"
                                                           step="${1}">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                               name="newsType" id="gridRadios${i}"
                                                               value="${listtypenews[i].id}">
                                    ...
                                    <input hidden name="id" value="${newsup.id}">
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit"
