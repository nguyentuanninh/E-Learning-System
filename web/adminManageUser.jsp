                        ...
                        <table class="table bg-white table-bordered">
                            <div
                                ...
                                <div
                                    ...
                                    <a href="addUser.jsp" type="button" class="btn btn-primary ml-4" style=" white-space: nowrap;">Create</a>
                                </div>
                                ...
                                <c:forEach items="${listUser}" var="c">
                                    <tr>
                                        ...
                                        <c:if test="${!c.disabled}">
                                            <td>
                                                <form
                                                    action="adminManageUser?idUser=${c.id}&Disabled='true'"
                                                ...
                                                <a href="resetPasswordUser?id=${c.id}&username=${c.username}"
                                        ...
                                        <c:if test="${c.disabled}">
                                            <td>
                                                <form
                                                    action="adminManageUser?idUser=${c.id}&Enabled='true'"
                                                    method="POST" class="d-inline">
                                                    <button type="submit"
                                    ...
                                    <c:forEach begin="1" end="${numberOfPage}" var="i">
                                        <c:if test="${i== page}">
                                            <li class="page-item active" aria-current="page">
                                                <a class="page-link"
                                                   href="adminManageUser?page=${i}">${i}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${i!= page}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="adminManageUser?page=${i}">${i}</a></li>
                                            </c:if>
