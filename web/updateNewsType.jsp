            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800 pb-4">Update News Type</h1>

                        <form action="updateNewsType" method="post">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea class="form-control" id="Type"
                                                      ...
                                                      required>${newsG.name}</textarea>
                                        </div>
                                    </div>
                                    
                                    <input hidden name="id" value="${newsG.id}">
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit"
