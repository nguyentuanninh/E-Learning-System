        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                ...
                <head>
                    ...
                    <link href="/SWP391_Group3/css/mobiscroll.javascript.min.css" rel="stylesheet" />
                    <script src="/SWP391_Group3/js/mobiscroll.javascript.min.js"></script>
                    <script
                ...
                <body id="page-top">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" id="Objective"
                                                                    ...
                                                                    required>${course.objectives}</textarea>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select id="catogory" name="catogory"
                                                                    ...
                                                                    <c:forEach items="${category}" var="category"
                                                                        varStatus="loop">
                                                                        <c:if test="${category.id== course.category}">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                <select id="multiple-select" multiple name="instructor"
                                                                    ...
                                                                    <c:forEach items="${listInstructor}"
                                                                        ...
                                                                        <c:if test="${listI.contains(instructor.id)}">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="image-area mt-4">
                                                            <img id="imageResult" src="${course.image}" alt=""
                    ...
                    <script src="/SWP391_Group3/js/demo/custom.js"></script>
                    <script>/*  ==========================================
     SHOW UPLOADED IMAGE
     * ========================================== */
