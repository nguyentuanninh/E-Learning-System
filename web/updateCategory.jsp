                                ...
                                <%@include file="topBar.jsp" %>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <form method="post" action="update-category" style="width: 60%; margin: 0 auto;"
                                            ...
                                            <button type="submit" class="btn btn-primary" title="add">Save
                                                Change</button>
                                        </form>
                                    </div>
                                    <!-- /.container-fluid -->
