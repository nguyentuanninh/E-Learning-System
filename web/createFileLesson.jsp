        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                ...
                <head>
                    ...
                    <title>File Lesson Creation</title>
                                ...
                                <div id="content">
                                    ...
                                    <%@include file="topBar.jsp" %>
                                        ...
                                        <div class="container-fluid">
                                            <h1 class="h3 mb-2 text-gray-800 pb-4">Upload file Lesson</h1>
                                            <form action="createLesson" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        id="exampleFormControlInput1" placeholder="Lesson Title">
                                                </div>
                                                <div class="form-group">
