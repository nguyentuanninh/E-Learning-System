...
<html lang="en">
    ...
    <head>
        ...
        <title>About-Type Edition</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800 pb-4">Update About Type</h1>

                        <form action="updateAboutType" method="post">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea class="form-control" id="Type"
                                                      name="type" rows="7" placeholder="News Type"
                                                      required>${abtT.type}</textarea>
                                        </div>
                                    </div>
                                        <div class="form-group row">
                                        <label for="Type_VN"
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea class="form-control" id="Type_VN"
                                                      name="type_vn" rows="7" placeholder="News Type VN"
                                                      required>${abtT.type_vn}</textarea>
                                        </div>
                                    </div>
                                    
                                    <input hidden name="id" value="${abtT.id}">
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit"
