...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Comment of course: <strong>${course.name}</strong></h1>
                            ...
                            <div
                                ...
                                <tbody id="aaa">
                                    <c:forEach items="${listComment}" var="c">
                                        <tr class="acc">
                                            <td>${mapUser.get(c.userId).username}</td>
                                            <td>${c.rating}</td>
                                            <td>${c.reviewText}</td>
                                            <td>
        ...
        <script>function loadMore() {
                                    ...
                                    $.ajax({
                                        url: "/SWP391_Group3/AdminLoadMoreComment",
