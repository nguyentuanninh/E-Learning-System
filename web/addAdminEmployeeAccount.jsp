    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="site-wrap">
            ...
            <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
                <div class="container">
                    <div class="row align-items-end justify-content-center text-center">
                        <div class="col-lg-7">
                            <h2 class="mb-0">Add Admin Employee </h2>
            ...
            <div class="custom-breadcrumns border-bottom">
                <div class="container">
                    <a href="AdminEmployeeAccount">Employee Managerment</a>
            ...
            <div class="site-section">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-5">
                            <form action="AddEmployee" method="post" onsubmit="return checkValidate()">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group" style="position: relative;">
                                        ...
                                        <input type="password" id="pword2" 
                                               class="form-control form-control-lg" 
                                               name="re-password" value="${requestScope.re_password}">
                                        <i class="ti-eye" style="position: absolute; bottom: 18px; right: 30px" onclick="viewpassword()"></i>
                                    </div>
                                </div>
                                <div class="row">
