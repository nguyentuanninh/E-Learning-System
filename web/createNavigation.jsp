            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-2 text-gray-800">Create Navigation In ${requestScope.parent_name}</h1>
                        <form action="create-navigation" method="POST">
                            <input type="hidden" value="${requestScope.parent_id}" <c:if test="${parent == 1}">name="navigation"</c:if>
                                   <c:if test="${parent == 2}">name="parent"</c:if>> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="namevn" name="name_vn">
                            </div>
                            <div class="form-group">
