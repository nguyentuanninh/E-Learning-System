<%-- 
    ...
    Created on : May 14, 2023, 9:30:16 AM
    Author     : Admin
--%>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            <a href="login.html" class="small mr-3"><span class="icon-unlock-alt"></span> Đăng Nhập</a>
          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-xl-block">
                ...
                <li>
                  <a href="about.html" class="nav-link text-left">Giảng Viên</a>
                </li>
                <li>
                  <a href="courses.html" class="nav-link text-left">Khoá Học</a>
                </li>
                <li>
