                                ...
                                <div id="content">
                                    ...
                                    <%@include file="topBar.jsp" %>
                                        ...
                                        <div class="container-fluid">
                                            <h1 class="h3 mb-2 text-gray-800 text-center">Add new Contact</h1>
                                            <form method="post" action="add-contact-comPany"
                                                style="width: 60%; margin: 0 auto;" enctype="multipart/form-data">
                                                <!--                            <div class="form-group">
                                <label for="exampleFormControlInput1">Name</label>
                                <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Alex" required="">
                            </div>-->
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput2">Phone</label>
                                                    <input type="text" name="phone" class="form-control"
                                                        id="exampleFormControlInput2" placeholder="0123456789"
                                                        required="">
                                                </div>
                                                <div class="form-group">
