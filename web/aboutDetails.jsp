                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3"
                                    ...
                                    <h3 class="m-0 font-weight-bold text-primary">${abt.title}</h3>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div style="text-align: right">
                                                <p>From:
                                                    <fmt:formatDate pattern="dd-MM-yyyy"
                                                                    value="${abt.createdDate}" />
                                                </p>
                                                <c:if test="${abt.modifiedDate != null}"></c:if>
                                                    <p>Modified from:
                                                    <fmt:formatDate pattern="dd-MM-yyyy"
                                                                    value="${abt.modifiedDate}" />
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-header py-3"
                                     style="display: flex; justify-content: space-between;">
                                    <h3 class="m-0 font-weight-bold text-primary">${abt.title_vn}</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <div>
