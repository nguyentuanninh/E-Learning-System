                        ...
                        <table class="table bg-white table-bordered">
                            <div
                                ...
                                <div
                                    ...
                                    <form action="AdminEmployeeAccount" method="get">
                                    ...
                                    <a href="addAdminEmployeeAccount.jsp" type="button" class="btn btn-primary ml-4" style=" white-space: nowrap;">Create</a>
                                </div>
                                ...
                                <c:forEach items="${listAcc}" var="c">
                                    <tr>
                                        ...
                                        <c:if test="${!c.disabled}">
                                            <td>
                                                <form
                                                    action="AdminEmployeeAccount?idAcc=${c.id}&Disabled='true'"
                                                ...
                                                <a href="ResetPasswordEmployee?id=${c.id}&username=${c.username}"
                                        ...
                                        <c:if test="${c.disabled}">
                                            <td>
                                                <form
                                                    action="AdminEmployeeAccount?idAcc=${c.id}&Enabled='true'"
                                                    method="POST" class="d-inline">
                                                    <button type="submit"
                                    ...
                                    <c:forEach begin="1" end="${numberOfPage}" var="i">
                                        <c:if test="${i== page}">
                                            <li class="page-item active" aria-current="page">
                                                <a class="page-link"
                                                   href="AdminEmployeeAccount?page=${i}">${i}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${i!= page}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="AdminEmployeeAccount?page=${i}">${i}</a></li>
                                            </c:if>
