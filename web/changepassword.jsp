            ...
            <div class="site-section">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-5">
                            <form action="forgotpassword" method="post" onsubmit="return checkValidate()">
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label for="username">Username</label>
                                        <p style="color: red" id="username_err">${requestScope.username_error}</p>
                                        <input type="text" id="username" class="form-control form-control-lg" value="${requestScope.username}" name="username">
                                    </div>
                                </div>
                                <div class="row">
