...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"
              rel="stylesheet">
        <title>News Approved Management</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table bg-white table-bordered">
                                        <div
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">News Approved
                                                Management </h6>
                                            <div
                                                style="display: flex; flex-direction: row; align-items: center;">
                                                <form action="listNewsApproved" method="get">
                                        ...
                                        <tbody>
                                            <c:if test="${requestScope.news.size()!= 0}">
                                                <c:forEach begin="${0}"
                                                           end="${requestScope.news.size() - 1}" var="i"
                                                           step="${1}">
                                                    <tr>
                                                        <td>${requestScope.news[i].title}</td>
                                                        <td>
                                                        ...
                                                        <td style="width: 13%;">
                                                            <a href="updateNews?id=${requestScope.news[i].id}"
                                                            ...
                                                            <a href="deleteNews?id=${requestScope.news[i].id}"
                                                               class="btn btn-primary btn-sm btn-circle"
                                                               style="text-decoration: none;"
                                                               title="Detele News"
                                                               onclick="return confirm('Are you sure delete news id: ${requestScope.news[i].id}?');">
                                                    ...
                                                    <c:if test="${i== page}">
                                                        <li class="page-item active"
                                                            ...
                                                            <c:if test="${param.search== null}">
                                                                <a class="page-link"
                                                                   href="listNewsApproved?page=${i}">${i}</a>
                                                            </c:if>
                                                            <c:if test="${param.search!= null}">
                                                                <a class="page-link"
                                                                   href="listNewsApproved?search=${param.search}&page=${i}">${i}</a>
                                                            </c:if>
