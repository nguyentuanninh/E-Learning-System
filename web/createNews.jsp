                            ...
                            <div id="content">
                                ...
                                <%@include file="topBar.jsp" %>
                                    ...
                                    <div class="container-fluid">
                                        <!-- Page Heading -->
                                        <h1 class="h3 mb-2 text-gray-800 pb-4">Create News</h1>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" id="Title" name="title"
                                                                rows="3" placeholder="News title" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" id="Description" name="description"
                                                                rows="3" placeholder="News Description" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="Content"
                                                        ...
                                                        <div class="col-sm-10 ">
                                                            <textarea class="form-control" id="Content" name="content"
                                                                rows="7" placeholder="News content"></textarea>
                                                        </div>
                                                    </div>
                                                    <fieldset class="form-group">
                                                        <div class="row">
                                                            <legend class="col-form-label col-sm-2 pt-0">Type of
                                                                news</legend>
                                                            <div class="col-sm-10">
                                                                <c:forEach begin="${0}" end="${listtypenews.size() - 1}"
                                                                    var="i" step="${1}">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div
                                                        ...
                                                        <input id="upload" type="file" onchange="readURL(this);"
                                                            accept="image/*" class="form-control border-0" name="images"
                                                            required>
                                                    </div>
